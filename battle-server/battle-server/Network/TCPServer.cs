...
namespace BattleServer.Network
{
    ...
    public class TCPServer
    {
        ...
        private void OnSessionError(long sessionId, int errorCode, string errorText)
        {
            ...
            m_onErrorHandle(sessionId, errorCode, errorText);
        }
        ...
        private void OnAccpetComplete(object o)
        {
            ...
            if (args.SocketError == SocketError.Success)
            {
                ...
                try
                {
                    ...
                    m_totalSessionId++;
                    session.StartAsServer(socket, m_totalSessionId, m_bufferPool, OnSessionError, m_onReadCompleteHandle, userToken);
